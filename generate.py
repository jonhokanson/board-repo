...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .modal-header-logo {{ position:absolute; top:50%; right:-18px; transform:translateY(-50%); width:150px; height:150px; object-fit:contain; opacity:0.3; pointer-events:none; filter:brightness(0) invert(1) drop-shadow(0 0 8px rgba(0,0,0,0.25)); }}
