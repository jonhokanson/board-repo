...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .modal-header-logo {{ position:absolute; top:50%; right:-18px; transform:translateY(-50%); width:150px; height:150px; object-fit:contain; opacity:0.55; pointer-events:none; filter:drop-shadow(0 0 10px rgba(0,0,0,0.35)); }}
