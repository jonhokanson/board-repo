...
<style>
  ...
  * {{ box-sizing:border-box; }}
  ...
  .modal-header {{ position:relative; padding:20px 52px 18px 20px; display:flex; align-items:center; gap:14px; color:#fff; }}
...
// Brand colors are approximate, just for a header gradient -- not sourced
// from an API, and easy to touch up later. Every NFL team is covered so
// there's always a real gradient; TEAM_STYLE_FALLBACK only kicks in if a
// pool entry's nflTeam string somehow doesn't match one of these exactly.
const TEAM_STYLE = {{
  ...
  "Cleveland Browns": {{primary:"#472A08", secondary:"#FF3C00", abbr:"CLE"}},
  "Dallas Cowboys": {{primary:"#041E42", secondary:"#869397", abbr:"DAL"}},
  "Denver Broncos": {{primary:"#FB4F14", secondary:"#002244", abbr:"DEN"}},
  "Detroit Lions": {{primary:"#0076B6", secondary:"#5A6266", abbr:"DET"}},
  "Green Bay Packers": {{primary:"#203731", secondary:"#FFB612", abbr:"GB"}},
  "Houston Texans": {{primary:"#03202F", secondary:"#A71930", abbr:"HOU"}},
  "Indianapolis Colts": {{primary:"#002C5F", secondary:"#A5ACAF", abbr:"IND"}},
  "Jacksonville Jaguars": {{primary:"#006778", secondary:"#101820", abbr:"JAX"}},
  "Kansas City Chiefs": {{primary:"#E31837", secondary:"#FFB612", abbr:"KC"}},
  "Las Vegas Raiders": {{primary:"#A5ACAF", secondary:"#000000", abbr:"LV"}},
  "Los Angeles Chargers": {{primary:"#0080C6", secondary:"#FFC20E", abbr:"LAC"}},
  "Los Angeles Rams": {{primary:"#003594", secondary:"#FFA300", abbr:"LAR"}},
  "Miami Dolphins": {{primary:"#008E97", secondary:"#F58220", abbr:"MIA"}},
  "Minnesota Vikings": {{primary:"#4F2683", secondary:"#FFC62F", abbr:"MIN"}},
  "New England Patriots": {{primary:"#002244", secondary:"#C60C30", abbr:"NE"}},
  "New Orleans Saints": {{primary:"#9F8458", secondary:"#101820", abbr:"NO"}},
...
const TEAM_STYLE_FALLBACK = {{primary:"#2a3a48", secondary:"#16212c", abbr:""}};
...
function openPlayerModal(name) {{
  ...
  document.getElementById('modalBody').innerHTML = `
    <div class="modal-header" style="background:linear-gradient(135deg, ${{team.primary}}, ${{team.secondary}})">
